export default {
  ...
  login: {
    title: 'Khung đăng nhập',
    logIn: 'Đăng nhập',
    username: 'Tên tài khoản',
    password: 'Mật khẩu',
    any: 'any',
    thirdparty: 'Kết nối với mạng xã hội',
    thirdpartyTips: 'Không thể được mô phỏng trên cục bộ, vì vậy hãy kết hợp mô phỏng doanh nghiệp của riêng bạn! ! !'
  },
  documentation: {
